...
const ProductDAO = {
  ...
  async update(product) {
    const newvalues = { name: product.name, price: product.price, image: product.image, imageDetails: product.imageDetails, category: product.category }; //  imageDetails: product.imageDetails,
