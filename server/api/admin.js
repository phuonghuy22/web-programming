...
router.post('/products', JwtUtil.checkToken, async function (req, res) {
  ...
  const product = { name: name, price: price, image: image, imageDetails: imageDetails,  cdate: now, category: category }; // imageDetails: imageDetails, 
...
router.put('/products/:id', JwtUtil.checkToken, async function (req, res) {
  ...
  const now = new Date().getTime(); // milliseconds
  const category = await CategoryDAO.selectByID(cid);
  const product = { _id: _id, name: name, price: price, image: image, imageDetails: imageDetails, cdate: now, category: category }; // imageDetails: imageDetails, 
