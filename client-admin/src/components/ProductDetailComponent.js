...
class ProductDetail extends Component {
        ...
        <form>
          <table>
            <tbody>
              ...
              <tr>
                <td>Category</td>
                <td><select onChange={(e) => { this.setState({ cmbCategory: e.target.value }) }}>
  ...
  previewImageDetails(e) {
   ...
   btnAddClick(e) {
    ...
    const imageDetails = this.state.imgDetails.map((img) =>img.replace(/^data:image\/[a-z]+;base64,/, '')); // removev "data:image/...;base64,"
